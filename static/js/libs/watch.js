...
// FUNÇÂO QUE VIRIFICA QUANDO MODAL É ABERTO E CORRIGE PROBLEMAS DO PADDING

let $div = document.querySelectorAll('body')
watch($div, 'padding-right', function() {
  if(!$('body').hasClass('modal-open')){
    $('#header').removeAttr('style')
  }
  if($('body').hasClass('modal-open')){
    $('#header').attr('style', 'padding-right: 15px')
  }
})
